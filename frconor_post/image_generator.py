...
def build_comic_prompt(
    ...
    prompt_parts = [
        ...
        "- DENSE, RICH panels — fill every panel with visual detail",
        "- NO empty space or whitespace — every area must have something",
        "- Full detailed BACKGROUNDS in each panel (environments, textures, objects)",
        "- Characters grounded in their environment, not floating in empty space",
        "",
        "Technical Requirements:",
